...
# "Nimbus_Fall_2018", "ColemanAltRel_2021", "ColemanAltRel_2022"
...
write_csv(reach_surv, paste0("./Survival/Reach Survival Per 10km/", 
...
write_csv(cum_surv, paste0("./Survival/Cumulative Survival/", 
